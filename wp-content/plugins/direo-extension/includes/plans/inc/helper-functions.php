 ...
 */
if (!function_exists('atpp_need_to_charge_with_plan')) {
    function atpp_need_to_charge_with_plan()
    {
...
if (!function_exists('atpp_need_listing_to_refresh')) {
    function atpp_need_listing_to_refresh($user_id = null, $order_id = null, $plan_id = null)
    {
