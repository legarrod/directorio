...
if (!function_exists('bdmv_load_more_filter')) {
    ...
    function bdmv_load_more_filter($my_query, $pageno = null, $sKeyword = '')
    {
        ...
        $totalpages = $pages;
        $ajax_pagin_classes = 'pagination bdmv-filter-pagination-ajx';
        if (is_author()) {
            $ajax_pagin_classes = '';
        }
        if (!empty($pages) && $pages > 1) {
            $output .= '<nav class="bdmv-pagination navigation ' . $ajax_pagin_classes . '">';
            ...
            while ($pages > 0) {
                ...
                if (isset($pageno) && !empty($pageno)) {
                    ...
                    if (!empty($totalpages) && $totalpages < 7) {
                        if ($pageno == $n) {
                            $output .= '<a data-skeyword="' . $sKeyword . '" data-pageurl="' . $n . '"  id="bdmv-page" class="page-numbers haspaglink current">' . $n . '</a>';
                        } else {
                            $output .= '<a data-skeyword="' . $sKeyword . '" data-pageurl="' . $n . '"  id="bdmv-page" class="page-numbers haspaglink">' . $n . '</a>';
                        }
                        ...
                        if ($pageno == $n) {
                            ...
                            if ($n <= 4) {
                                ...
                                $output .= '<a data-skeyword="' . $sKeyword . '" data-pageurl="' . $n . '" id="bdmv-page" class="page-numbers haspaglink">' . $n . '</a>';
                                $output .= '<a data-skeyword="' . $sKeyword . '" id="bdmv-page" class="page-numbers">...</a>';
                                $flagAt2 = 1;
                                ...
                                <div class="atbd_listing_info">
                                    <div class="atbd_content_upper">
                                                    ...
                                                    if (!empty($display_publish_date)) { ?>
                                                        <li><p>
                                                                ...
                                                                if ('time_ago' === $publish_date_format) {
                                                                    printf(__('Posted %s ago', 'direo-extension'), human_time_diff(get_the_time('U'), current_time('timestamp')));
                                                                } else {
                                                                    echo get_the_date();
                                                                }
                                                                ?></p></li>
                                        ...
                                        <?php if (!empty($excerpt) && !empty($enable_excerpt) && !empty($display_excerpt_field)) {
                                            ...
                                            $readmore_text = get_directorist_option('readmore_text', __('Read More', 'direo-extension'));
                                            ?>
                                            ...
                                            if (!empty($display_readmore)) {
                                                ?><a
                                                href="<?php the_permalink(); ?>"><?php printf(__(' %s', 'direo-extension'), $readmore_text); ?></a></p>
                                            <?php }
                                        }
                                    ...
                                    if (!empty($display_category) || !empty($display_view_count) || !empty($display_author_image)) {
                                        ...
                                        if (!empty($display_category)) {
                                            if (!empty($cats)) {
                                                ...
                                                $catViewCountAuthor .= '<span class="' . atbdp_icon_type() . '-tags"></span>';
                                                $catViewCountAuthor .= __('Uncategorized', 'direo-extension');
                                                $catViewCountAuthor .= '</a>';
                                                $catViewCountAuthor .= '</div>';
                                                $catViewCountAuthor .= '</div>';
                                            }
...
if (!function_exists('bdmv_header_advance_search')) {
    ...
    function bdmv_header_advance_search($search_more_filters_fields, $filters_button, $hidden_var)
    {
        ...
        ?>
        <div class="ads_slide" data-nonce="<?php echo wp_create_nonce('bdlm_ajax_nonce') ?>" id="bdlm-search-area">
            <div class="ads-advanced">
                    ...
                    <div class="row atbdp-search-form">
                            ...
                            <div class="col-md-6 col-sm-12 col-lg-4 search-text" data-text="yes">
                                <div class="single_search_field search_query">
                                    <input class="form-control search_fields" type="text" name="q"
                                           placeholder="<?php _e('What are you looking for?', 'direo-extension'); ?>">
                                </div>
                            </div>
                        <?php }
                        ...
                        if ('yes' == $search_location) {
                            if ('listing_location' == $listing_map_location_address) {
                                ...
                                ?>
                                <div class="col-md-12 col-sm-12 col-lg-4 search-location" data-loc="yes">
                                    ...
                                    <div class="atbdp_map_address_field">
                                        <div class="atbdp_get_address_field">
                                            <input type="text" name="address" id="address"
                                                   ...
                                                   placeholder="<?php _e('location', 'direo-extension'); ?>"
                                                   autocomplete="off"
                ...
                <?php if (("yes" == $search_price) || ("yes" == $search_price_range)) { ?>
                    <div class="form-group ">
                        ...
                        <label class=""><?php _e('Price Range', 'direo-extension'); ?></label>
                            ...
                            <?php if ("yes" == $search_price) {
                                ...
                                <div class="range_single" data-price="yes">
                                    <input type="text" name="price[0]" class="form-control price"
                                           placeholder="<?php _e('Min Price', 'direo-extension'); ?>"
                                ...
                                <div class="range_single">
                                    <input type="text" name="price[1]" class="form-control price"
                                           placeholder="<?php _e('Max Price', 'direo-extension'); ?>"
                ...
                <?php if ("yes" == $search_rating) { ?>
                    <div class="form-group search-rating" data-rating="yes">
                        ...
                        <select name='search_by_rating' class="select-basic form-control">
                            <option value=""><?php _e('Select Ratings', 'direo-extension'); ?></option>
                            <option value="5" <?php if ((!empty($_GET['search_by_rating']) && '5' == $_GET['search_by_rating']) || (!empty($_POST['search_by_rating']) && '5' == $_POST['search_by_rating'])) {
                                echo "selected";
                            } ?>><?php _e('5 Star', 'direo-extension'); ?></option>
                            <option value="4" <?php if ((!empty($_GET['search_by_rating']) && '4' == $_GET['search_by_rating']) || (!empty($_POST['search_by_rating']) && '4' == $_POST['search_by_rating'])) {
                                echo "selected";
                            } ?>><?php _e('4 Star & Up', 'direo-extension'); ?></option>
                            <option value="3" <?php if ((!empty($_GET['search_by_rating']) && '3' == $_GET['search_by_rating']) || (!empty($_POST['search_by_rating']) && '3' == $_POST['search_by_rating'])) {
                                echo "selected";
                            } ?>><?php _e('3 Star & Up', 'direo-extension'); ?></option>
                            <option value="2" <?php if ((!empty($_GET['search_by_rating']) && '2' == $_GET['search_by_rating']) || (!empty($_POST['search_by_rating']) && '2' == $_POST['search_by_rating'])) {
                                echo "selected";
                            } ?>><?php _e('2 Star & Up', 'direo-extension'); ?></option>
                            <option value="1" <?php if ((!empty($_GET['search_by_rating']) && '1' == $_GET['search_by_rating']) || (!empty($_POST['search_by_rating']) && '1' == $_POST['search_by_rating'])) {
                                echo "selected";
                            } ?>><?php _e('1 Star & Up', 'direo-extension'); ?></option>
                        </select>
                    </div><!-- ends: .form-group -->
                <?php } ?>
                <?php if ('map_api' == $listing_map_location_address && "yes" == $radius_search) {
                    ...
                    <div class="form-group search-radius" data-radius="yes">
                        <div class="atbdpr-range rs-primary">
                            <span><?php _e('Radius Search', 'direo-extension'); ?></span>
                ...
                if ("yes" == $search_open_now && in_array('directorist-business-hours/bd-business-hour.php', apply_filters('active_plugins', get_option('active_plugins')))) { ?>
                    <div class="form-group search-open" data-open="yes">
                        <label><?php _e('Open Now', 'direo-extension'); ?></label>
                        <div class="check-btn">
                            <div class="btn-checkbox">
                                <label>
                                    ...
                                    <span><i class="fa fa-clock-o"></i><?php _e('Open Now', 'direo-extension'); ?> </span>
                                </label>
                            </div>
                        </div>
                    </div><!-- ends: .form-group -->
                ...
                if ("yes" == $search_tag) {
                    ...
                    if (!empty($terms)) {
                        ...
                        <div class="form-group ads-filter-tags" data-tag="yes">
                            <label><?php echo !empty($tag_label) ? $tag_label : __('Tags', 'direo-extension'); ?></label>
                            <div class="bads-tags">
                                <?php
                                $rand = rand();
                            ...
                            <a href="#"
                               class="more-less ad"><?php _e('Show More', 'direo-extension'); ?></a>
                            ...
                            <?php if ("yes" == $search_website) {
                                ...
                                <div class="search-website" data-website="yes">
                                    <input type="text" name="website"
                                           placeholder="<?php echo !empty($website_label) ? $website_label : __('Website', 'direo-extension'); ?>"
                            ...
                            if ("yes" == $search_email) {
                                ...
                                <div class="search-email" data-email="yes">
                                    <input type="text" name="email"
                                           placeholder="<?php echo !empty($email_label) ? $email_label : __('Email', 'direo-extension'); ?>"
                            ...
                            if ("yes" == $search_phone) {
                                ...
                                <div class="search-phone" data-phone="yes">
                                    <input type="text" name="phone"
                                           placeholder="<?php _e('Phone Number', 'direo-extension'); ?>"
                            ...
                            if ("yes" == $search_fax) {
                                ...
                                <div class="search-fax" data-fax="yes">
                                    <input type="text" name="fax"
                                           placeholder="<?php echo !empty($fax_label) ? $fax_label : __('Fax', 'direo-extension'); ?>"
                            ...
                            if ("yes" == $search_zip_code) {
                                ...
                                <div class="search-zip" data-zip="yes">
                                    <input type="text" name="zip_code"
                                           placeholder="<?php echo !empty($zip_label) ? $zip_label : __('Zip/Post Code', 'direo-extension'); ?>"
                ...
                <div class="bdas-filter-actions">
                    <?php if ("yes" == $search_reset_filters) {
                        ...
                        <button type="reset"
                                ...
                                data-reset="yes"><?php _e('Reset Filters', 'direo-extension'); ?></button>
                    <?php }
                    if ("yes" == $search_apply_filters) { ?>
                        <button type="submit"
                                class="btn btn-primary btn-sm ajax-search"
                                data-apply="yes"><?php _e('Apply Filters', 'direo-extension'); ?></button>
                    <?php } ?>
