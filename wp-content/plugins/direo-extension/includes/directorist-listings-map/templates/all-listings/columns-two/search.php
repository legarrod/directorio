...
<div class="atbdp search-area default-ad-search" data-nonce="<?php echo wp_create_nonce('bdlm_ajax_nonce')?>" id="bdlm-search-area">
    <?php if (in_array('search_text', $listings_with_map_filter_fields) && in_array('search_text', $visible_fields)) { ?>
    ...
    <?php } ?>
    <?php if (in_array('search_location', $listings_with_map_filter_fields) && in_array('search_location', $visible_fields)) {
    ...
    <?php } else {
        ...
        <div class="form-group">
            <div class="position-relative">
                <input type="text" name="address" id="address" autocomplete="off" value="<?php echo !empty($_GET['address']) ? $_GET['address'] : ''; ?>" placeholder="<?php  _e('Location','direo-extension');?>"
    ...
    <?php if (in_array('search_category', $listings_with_map_filter_fields) && in_array('search_category', $visible_fields)) { ?>
            <div class="form-group">
    ...
    <?php } ?>
    <?php if (in_array('search_price', $listings_with_map_filter_fields) && in_array('search_price', $visible_fields)) { ?>
            <div class="form-group ">
    ...
    <?php } ?>
    <?php if ('map_api' == $listing_map_location_address && in_array('radius_search', $listings_with_map_filter_fields) && in_array('radius_search', $visible_fields)) {
    ...
    <?php } ?>
    <?php if (in_array('search_price_range', $listings_with_map_filter_fields) && in_array('search_price_range', $visible_fields)) { ?>
        <div class="form-group">
    ...
    <?php } ?>
    <?php if (in_array('search_open_now', $listings_with_map_filter_fields) && in_array('search_open_now', $visible_fields) && in_array('directorist-business-hours/bd-business-hour.php', apply_filters('active_plugins', get_option('active_plugins')))) { ?>
        <div class="check-btn form-group">
    ...
    <?php } ?>
    <?php if (in_array('search_custom_fields', $listings_with_map_filter_fields) && in_array('search_custom_fields', $visible_fields) && 0 < $custom_field_post ) { ?>
        <div id="atbdp-custom-fields-search" class="atbdp-custom-fields-search form-group">
            <?php do_action( 'wp_ajax_atbdp_custom_fields_search', isset( $_GET['in_cat'] ) ? $_GET['in_cat'] : 0 ); ?>
        </div>
    <?php } ?>
    <?php if (in_array('search_website', $listings_with_map_filter_fields) && in_array('search_website', $visible_fields)) { ?>
        <div class="form-group">
    ...
    <?php } ?>
    <?php if (in_array('search_email', $listings_with_map_filter_fields) && in_array('search_email', $visible_fields)) { ?>
        <div class="form-group">
    ...
    <?php } ?>
    <?php if (in_array('search_phone', $listings_with_map_filter_fields) && in_array('search_phone', $visible_fields)) { ?>
        <div class="form-group">
    ...
    <?php } ?>
    <?php if (in_array('search_zip_code', $listings_with_map_filter_fields) && in_array('search_zip_code', $visible_fields)) { ?>
        <div class="form-group">
            <div class="position-relative">
    ...
    <?php } ?>
    <?php
    if (in_array('search_tag', $listings_with_map_filter_fields) && in_array('search_tag', $visible_fields)) {
    ...
    <?php } ?>
    <?php if (in_array('search_rating', $listings_with_map_filter_fields) && in_array('search_tag', $visible_fields)) { ?>
        <div class="form-group filter-checklist">
    ...
    <div class="dlm-action-wrapper dlm-filter-slide"> <!-- .dlm-filter-slide / .dlm-filter-dropdown -->

        <button type="Submit" class="btn btn-primary ajax-search"><?php _e( 'Search', 'direo-extension' ); ?></button>
        <?php if (!in_array('search_text', $visible_fields) || !in_array('search_category', $visible_fields) || !in_array('search_location', $visible_fields) || !in_array('search_price', $visible_fields) || !in_array('search_price_range', $visible_fields) || !in_array('search_rating', $visible_fields) || !in_array('search_tag', $visible_fields) || !in_array('search_open_now', $visible_fields) || !in_array('search_custom_fields', $visible_fields) || !in_array('search_website', $visible_fields) || !in_array('search_email', $visible_fields) || !in_array('search_phone', $visible_fields) || !in_array('search_fax', $visible_fields) || !in_array('search_zip_code', $visible_fields) || !in_array('radius_search', $visible_fields)) { ?>
        <button class="btn btn-bordered dlm_filter-btn"><?php _e( 'More Filters', 'direo-extension' ); ?></button>
        <?php } ?>
    </div>
    <div class="dlm-filter-slide dlm-filter-slide-wrapper">
    <div class="atbd_more-filter-contents">
                ...
                <div class="form-group">
                    <div class="position-relative">
                        <input type="text" name="address" autocomplete="off" id="address" value="<?php echo !empty($_GET['address']) ? $_GET['address'] : ''; ?>" placeholder="<?php  _e('Location','direo-extension');?>"
                               class="form-control location-name"><span class="bdmv_get_loc la la-crosshairs"></span>
                    </div>
                    <?php $select_listing_map = get_directorist_option('select_listing_map', 'google');
                    if ('google' != $select_listing_map) {
                        echo '<div class="address_result"></div>';
        ...
        <?php } ?>
        <?php
        if (in_array('search_custom_fields', $listings_with_map_filter_fields) && !in_array('search_custom_fields', $visible_fields) && 0 < $custom_field_post) { ?>
        ...
        <?php } ?>
        <?php if (in_array('search_rating', $listings_with_map_filter_fields) && !in_array('search_rating', $visible_fields)) { ?>
            <div class="form-group filter-checklist">
                <label><?php _e('Filter by Ratings','direo-extension'); ?></label>
                <div class="sort-rating">
                    <div class="custom-control custom-checkbox checkbox-outline checkbox-outline-primary">
        ...
        <?php if ( in_array('search_reset_filters', $search_filters) || in_array('search_apply_filters', $search_filters) ) { ?>
            <div class="form-group submit_btn">
                <?php if (in_array('search_reset_filters', $search_filters)) { ?>
                    <button type="reset" class="btn btn-bordered"><?php _e( 'Reset', 'direo-extension' ); ?></button>
                <?php } ?>
                <?php if (in_array('search_apply_filters', $search_filters)) { ?>
                    <button type="submit" class="btn btn-primary ajax-search ajax-search-filter"><?php _e( 'Search Filters', 'direo-extension' ); ?></button>
                <?php } ?>
            </div>
        <?php } ?>
    </div>
